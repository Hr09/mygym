    ...
    <section class="hike-1">
      ...
      <footer id="contact">
          <div class="main_footer">
            <div class="footer_wrapper">
                <div class="first_section">
                  ...
                  <p style="color:white; text-align:center; letter-spacing:1px; text-align:justify">
                    <span><i class="fa fa-map-marker"></i></span>Lorem ipsum dolor sit amet, legendos lobortis eu ius, cu qui vocent vituperata, at justo conclusionemque vel. Illum scriptorem nec in,
                     his et detracto efficiantur. Alii atomorum per ne, no
                     tota causae nostrud qui, euripidis reprehendunt ea has
                     . Mea te diam nominavi, at mea habeo semper, mei eu
                      purto offendit consulatu.
                  </p>
                </div>
                <div class="second_section">
                    <h1  class="" style="color: white; padding-left:40px"> My usefull links</h1>
                    <ul class="ul-sec" style="padding-left:60px;padding-top:10px;">
            ...
            <div class="copyright" style="position:absolute; top:160%; width:100%; left:0;right: 0; bottom:0; color:white;">
              <p style="text-align:center">"All rights reserved" is a copyright formality indicating that the
                 ...
                 if it has any legal effect in any jurisdiction<br />&copy All right reserved 2019 | Hrithik Gaikwad<br /></p>
            </div>
